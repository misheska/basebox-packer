...
* [centos64](https://dl.dropboxusercontent.com/s/dqv65qk6j79mq3o/centos64.box?token_hash=AAEO0urkBZTTpS3ndrKg5ek2rnGCxfa2T56tQk3fK8-sBQ&dl=1) - CentOS 6.4 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [centos64-i386](https://dl.dropboxusercontent.com/s/guk2p3ypz456xlc/centos64-i386.box?token_hash=AAEwLvxb-pZUeyKYGABoHb-kwwD0OtvQuJQO0msKIVJWKQ&dl=1) - CentOS 6.4 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [centos59](https://dl.dropboxusercontent.com/s/6nc2grl7bneaou7/centos59.box?token_hash=AAHJ4-rJMtBDawC-qDCRC_YWsoHE2D2t3iuchPWdJ9cNqw&dl=1) - CentOS 5.9 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [centos59-i386](https://dl.dropboxusercontent.com/s/lb0q1vk3ojxypa2/centos59-i386.box?token_hash=AAHxzOJG4GhG5yJAAqqLPhRBFoL6liFnTT9nP-9dzkLH8g&dl=1) - CentOS 5.9 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
...
* [ubuntu1304]() - Ubuntu 13.04 server 64-bit VMware Fusion 6 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [ubuntu1304-i386]() - Ubuntu 13.04 server 32-bit VMware Fusion 6 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [ubuntu1204](https://dl.dropboxusercontent.com/s/19o6poe9jmk2kk4/ubuntu1204.box?token_hash=AAHeetBOJzLiKm9pLqvvB3SuBhcsh6DzNpGi6CWJP-vi9g&dl=1) - Ubuntu 12.04.3 server 64-bit VMware Fusion 6 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [ubuntu1204-i386](https://dl.dropboxusercontent.com/s/v8xg8h0prcwyzi5/ubuntu1204-i386.box?token_hash=AAFxXyN6YepuMwR7ENYxDWDjTuhCwyKwhgicikD9_fNiTg&dl=1) - Ubuntu 12.04.3 server 32-bit VMware Fusion 6 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [ubuntu1204-docker](https://dl.dropboxusercontent.com/s/c38u559ateohq64/ubuntu1204-docker.box?token_hash=AAHAM6vPqs12iGnty-yipAP9X1vjNeMqB9DdWe98DXcpsA&dl=1) - Ubuntu 12.04.3 server 64-bit with Docker VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [ubuntu1004](https://dl.dropboxusercontent.com/s/6vz2596sch7xi4l/ubuntu1004.box?token_hash=AAG9wXEu1PCIlCIxN8F3a9K_GoNCFZFiI72d_JJ5-VQxYA&dl=1) - Ubuntu 10.04.4 server 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [ubuntu1004-i386](https://dl.dropboxusercontent.com/s/u5uvx9kjdh3i6uk/ubuntu1004-i386.box?token_hash=AAFrMeCZ6dHGFMJRioK50mP75Jao77LdKQoKY0l1LRpPeQ&dl=1) - Ubuntu 10.04.4 server 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [fedora19]() - Fedora 19 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [fedora19-i386](https://dl.dropboxusercontent.com/s/3offsg1ye0qzxqv/fedora19-i386.box?token_hash=AAEpYEzWAbbfJFQOemD8e1F6qjQGy5FhGjFXKRoLJOF1vw&dl=1) - Fedora 19 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [fedora18]() - Fedora 18 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [fedora18-i386]() - Fedora 18 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
...
* [oracle64]() - Oracle Linux Release 6 Update 4 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle64-i386]() - Oracle Linux Release 6 Update 4 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle63]() - Oracle Linux Release 6 Update 3 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle63-i386]() - Oracle Linux Release 6 Update 3 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle62]() - Oracle Linux Release 6 Update 2 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle62-i386]() - Oracle Linux Release 6 Update 2 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle61]() - Oracle Linux Release 6 Update 1 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle61-i386]() - Oracle Linux Release 6 Update 1 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle510]() - Oracle Linux Release 5 Update 10 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle510-i386]() - Oracle Linux Release 5 Update 10 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle59]() - Oracle Linux Release 5 Update 9 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle59-i386](https://dl.dropboxusercontent.com/s/fsburywbcmikf06/oracle59-i386.box?token_hash=AAEMCflkvE1GGvJyKo70NA4otzqG_YqkDw9qMGgTHpXLZQ&dl=1) - Oracle Linux Release 5 Update 9 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle58]() - Oracle Linux Release 5 Update 8 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle58-i386](https://dl.dropboxusercontent.com/s/ixt0ao0m30sfsxl/oracle58-i386.box?token_hash=AAHi9CgAF6tuPpHt07U5OKSByGngDPZ0HooZtJTArq1j1Q&dl=1) - Oracle Linux Release 5 Update 8 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle57]() - Oracle Linux Release 5 Update 7 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [oracle57-i386](https://dl.dropboxusercontent.com/s/qj9kwtwgiw5x72b/oracle57-i386.box?token_hash=AAHe0ShK47CCkIpbh6lOlPIyDTm0f81ac-3YwLFFWLJWzA&dl=1) - Oracle Linux Release 5 Update 7 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [debian72]() - Debian "wheezy" 7.2 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [debian72-i386]() - Debian "wheezy" 7.2 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [debian71]() - Debian "wheezy" 7.1 64-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
* [debian71-i386]() - Debian "wheezy" 7.1 32-bit VMware Fusion 6 / VMware Workstation 10 basebox (VMware Tools 9.2.6.26048 build-1294478)
...
* [ubuntu1004-i386](https://dl.dropboxusercontent.com/s/u5uvx9kjdh3i6uk/ubuntu1004-i386.box?token_hash=AAFrMeCZ6dHGFMJRioK50mP75Jao77LdKQoKY0l1LRpPeQ&dl=1) - Ubuntu 10.04.4 server 32-bit VirtualBox basebox (VirtualBox 4.3.0 Guest Additions)
